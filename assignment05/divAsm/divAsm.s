...
divAsm
    PUSH {R0,LR}        // save the input argument and return address
                        // LR (return address) is saved because we call
                        // another function internally, the PrintString.
                        // thefore we must save LR.
    ...
    MOV R0, R0, LSR 1   // Move (R0 >> 1) into R0. Note LSR 1 is equivalent 
                        // to dividing by 2
